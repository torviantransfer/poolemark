...
export default function AdminLiveVisitorsPage() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-5 max-w-7xl">
      <div className="rounded-2xl border bg-white/90 backdrop-blur shadow-sm px-4 md:px-5 py-4">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-foreground">Canlı Ziyaretçiler</h1>
            <p className="text-sm text-muted-foreground mt-1">
              Anlık aktif ziyaretçi ve son 30 dakika dönüşüm hunisi
            </p>
          </div>
          <div className="flex items-center gap-2 text-xs">
            ...
            <span className="inline-flex items-center px-2.5 py-1 rounded-full border bg-secondary/30 text-muted-foreground">
              30 sn yenileme
            </span>
          </div>
        </div>
      ...
      <div className="grid gap-5 xl:grid-cols-12">
        <aside className="xl:col-span-4 space-y-4 xl:sticky xl:top-5 self-start">
          ...
          <div className="bg-white/90 backdrop-blur border rounded-2xl p-4 md:p-5">
          ...
          <div className="bg-white/90 backdrop-blur border rounded-2xl p-4 md:p-5">
            ...
            {topPagesNow.length === 0 ? (
              <p className="text-sm text-muted-foreground">Henüz aktif ziyaretçi yok.</p>
            ) : (
              <div className="space-y-2.5">
                {topPagesNow.map(([path, count]) => {
                  const max = Math.max(1, ...topPagesNow.map((x) => x[1]));
                  ...
                  return (
                    <div key={path} className="space-y-1">
                      ...
                      <div className="h-1.5 rounded-full bg-secondary/50 overflow-hidden">
                        <div className="h-full rounded-full bg-primary/70" style={{ width: `${Math.max(width, 8)}%` }} />
                      </div>
                    </div>
                  );
                })}
        ...
        <section className="xl:col-span-8 space-y-4">
          ...
          <div className="bg-white/90 backdrop-blur border rounded-2xl">
            <button
              type="button"
            ...
            >
              <span className="flex items-center gap-2">
                Detaylar
                <span className="text-xs font-normal text-muted-foreground">
                  (sayfa dağılımı ve ziyaretçi listesi)
                </span>
              </span>
