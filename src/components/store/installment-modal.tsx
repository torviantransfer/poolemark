  ...
  return (
    <>
      <button
        ...
        className="text-xs text-muted-foreground mt-1 hover:text-primary transition-colors text-left group"
      >
        12 taksitte yalnızca{" "}
        <span className="font-semibold text-foreground group-hover:text-primary underline underline-offset-2 decoration-dashed">
          {formatPrice(Math.ceil(price / 12))}/ay
        </span>
        <span className="ml-1 text-primary text-[11px]">· taksit tablosu →</span>
      </button>
            ...
            <div>
              ...
              <div className="rounded-xl border overflow-hidden">
                <table className="w-full text-sm">
                  <thead className="bg-secondary/60">
                    <tr>
                      <th className="text-left px-4 py-2.5 font-medium text-muted-foreground">Taksit</th>
